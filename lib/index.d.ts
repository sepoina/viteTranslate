...
export interface VitetranslateOptions {
   ...
   *
   * Non tocca il testo dentro un componente, né gli attributi di un componente: lì il
   * marcatore compilato va inoltrato a `<Translate>` o a `ts()`, che è ciò che fa già.
   * Default: `false`.
   */
