...
// Vincolo dichiarato lì in § "Invarianti da non rompere", punto 7.

/**
 * Divide le chiavi di un oggetto lingua in due gruppi ordinati alfabeticamente: tradotte e
 * non tradotte. Il criterio di "non tradotta" è parametrico: per una sub-lingua è "valore
 * null", per la lingua sorgente è "manca in almeno un'altra lingua" (vedi updateLanguage.js).
 *
 * @param {object} obj
