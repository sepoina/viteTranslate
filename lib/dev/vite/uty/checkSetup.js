 ...
 * Rollup/Rolldown chiami `load`): è il controllo che oggi vive dentro `generate`
 * (buildManifest.js), spostato qui perché lì gira alla prima richiesta del browser, tre volte
