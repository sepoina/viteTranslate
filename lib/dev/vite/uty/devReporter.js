 ...
 * dev`: lì non esiste un "abbiamo finito" — `buildEnd` non scatta mai e la fabbrica del
 * manifest (buildManifest.js) gira solo quando il modulo virtuale si invalida, cioè quasi
 * mai — e legare il flush a quei punti vuol dire che tutto ciò che i `transform` raccolgono
 * dopo l'ultimo di essi non viene stampato mai. Il timer chiude la raccolta quando la raffica si esaurisce, che è anche il
