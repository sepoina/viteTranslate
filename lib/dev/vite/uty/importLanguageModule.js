 ...
 * @param {string} [code] - il sorgente già letto, per chi lo ha in mano (il generatore del
 ...
 */
export default async function importLanguageModule(filePath, code = fs.readFileSync(filePath, "utf8")) {
