 ...
 * @param {boolean} p.icuEnabled - `false` solo in un'installazione atipica in cui
 *   `vitetranslate.js` non ha trovato il proprio `lib/` (piano 4.6.3): i messaggi ICU si
 *   compilano allora come testo semplice, e lo si segnala una volta.
 * @returns {object} il plugin Vite/Rollup "vitetranslate:compile-locale"
 */
export default function creaCompileLocale({ defs, localeDirPosix, reporter, localeModuleIds, leggiStato, icuEnabled }) {
  return {
