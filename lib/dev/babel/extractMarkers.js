...
import { compiledMarker, SOURCE_OPEN } from "../../markerSyntax.js";
 ...
 *
 * `@babel/core` è una peer dependency opzionale (arriva quasi sempre da
 * `@vitejs/plugin-react`, ma non è garantito): senza, questa funzione lancia un errore con
 * `code: "VT_NO_BABEL"`, che i due chiamanti (`cli.js`, `vitetranslate.js`) traducono nel loro
