 ...
 * @param {(message: string) => void} [options.warn] - dove segnalare marcatori annidati e
 *   collisioni di id; il default è la console col prefisso del plugin (vedi markerCore)
