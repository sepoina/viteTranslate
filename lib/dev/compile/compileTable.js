 ...
 */
export function compileEntry(source, used, warn) {
 ...
 * @param {{missingArg?: string, emitUntranslated?: boolean, warn?: (message: string, kind?: string) => void}} [options]
...
export function compileLanguageModule(table, tag = "", sourceTable = null, options = {}) {
  ...
  const emit = (key, value) => {
    ...
    const expr = typeof resolved === "string" ? compileEntry(resolved, used, warn) : JSON.stringify(resolved);
