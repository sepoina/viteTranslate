...
const NAMED = {
  ...
  amp: "&", lt: "<", gt: ">", quot: '"', apos: "'",
  // I caratteri di ICU, per scriverli letterali anche dentro un ramo plurale: lì "#" è il
  // numero, e &#35; o &#123; perderebbero il loro "#" (4.6.3: l'apostrofo non cita più).
  num: "#", lbrace: "{", rbrace: "}", lcub: "{", rcub: "}",
