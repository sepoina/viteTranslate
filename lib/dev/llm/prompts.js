...
/**
 * Il messaggio di sistema completo per una lingua: le regole, poi lingua target, lingua
 * sorgente, tono se c'è, e il contesto (se c'è) sotto "Project context:".
 *
 * @param {{ targetTag: string, sourceTag: string, tone?: string, context?: string }} params
 */
export function buildTranslateSystemPrompt({ targetTag, sourceTag, tone, context }) {
  const lines = [
    SYSTEM_TRANSLATE,
    "",
