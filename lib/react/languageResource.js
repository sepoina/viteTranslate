...
/** I tag delle lingue precaricate, nell'ordine in cui il bundle le importa. */
export const preloadedLanguages = Object.keys(languages).filter((tag) => languages[tag].preloaded);
