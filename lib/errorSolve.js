...
export function resolveDiagnostics(manifest) {
  ...
  return makeDiagnostics({
    ...
    // Non sono diagnostica in senso stretto, sono configurazione di build letta dal runtime,
    // come partiallyTranslated: l'interprete ICU di dev (null in produzione) e la locale della
    // lingua sorgente, che serve a formattare le voci ICU ricadute sul testo sorgente.
    icuDev: typeof manifest.icuDev === "function" ? manifest.icuDev : null,
