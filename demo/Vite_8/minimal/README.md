...
The tables in [`src/locale/`](src/locale) are generated by the sync command, reading the
...
directly) is the step that brings the change into `src/locale/`. In dev, saving a language
