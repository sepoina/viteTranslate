  ...
  return {
    ...
    buildStart: {
      ...
      handler: () => {
        ...
        globalThis['TranslateService'].baseLng = { "__lngVersion__":CalcolaVersion() } // spazio vuoto per gli elementi
  ...
  try {
    fs.readFile(filePath, 'utf8', (err, data) => {
      ...
      if (state.changed) {
        ...
        fs.writeFile(filePath, JSON.stringify(baseData, null, 2), 'utf8', (err) => {
          if (err) {
