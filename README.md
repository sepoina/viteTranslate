...
Each language is one JS module in `localeDir`, named after its BCP 47 tag (`it-IT.js`,
`en-US.js`, …), exporting the translation table as its default export. The **source
