    ...
    vitetranslate({
      ...
      llm: {
        connection: {
          ...
          apiKeyEnv: 'RESTAURANT_API_KEY',
          // $ per milione di token
          costMillionInput: 0.6,
          costMillionOutput: 1.2,
          modelClass: 'standard', // lotti fino a ~3k token di output / 100 chiavi
          // Solo DeepSeek: deepseek-flash ragiona di default, e il ragionamento finisce nello
          // stesso max_tokens della risposta (era il 78% dell'output). Per tradurre non serve.
          // Togli la riga per riaccenderlo: i lotti si ritarano da soli.
