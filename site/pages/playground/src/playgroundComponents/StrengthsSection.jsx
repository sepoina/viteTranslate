      ...
      <table className="strengths-table">
        <tbody>
          <tr>
            ...
            <td className="strength-text"><Translate t={"_%_<strong>Meno di 5 kB gzip nel bundle finale.</strong> Il runtime che arriva al browser (<code>&#60;Translate&#62;</code>, <code>TranslateContainer</code>, <code>useTranslateLanguage</code>) pesa meno di 5 kB gzip, misurati confrontando una build di produzione con e senza la libreria. Il payload delle traduzioni scala con i tuoi contenuti, non con la libreria._%_"} /></td>
          </tr>
          <tr>
          ...
          <tr>
            <td className="strength-icon" aria-hidden="true">🔍</td>
            <td className="strength-text"><Translate t={"_%_<strong>Nuove lingue rilevate in automatico.</strong> Basta aggiungere un file .yml nella cartella delle lingue, senza registrarlo altrove nel codice._%_"} /></td>
          </tr>
          <tr>
            <td className="strength-icon" aria-hidden="true">🔒</td>
            <td className="strength-text"><Translate t={"_%_<strong>Le tabelle sono dati, non moduli JS.</strong> Un file di lingua non porta codice eseguibile: viene compilato in fase di build, non servito com’è._%_"} /></td>
          </tr>
          <tr>
            <td className="strength-icon" aria-hidden="true">♻️</td>
