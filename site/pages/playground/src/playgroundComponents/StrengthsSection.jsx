      ...
      <table className="strengths-table">
        <tbody>
          <tr>
            ...
            <td className="strength-text"><Translate t={["_%_<strong>%s gzip nel bundle finale.</strong> Il runtime che arriva al browser (<code>&#60;Translate&#62;</code>, <code>TranslateContainer</code>, <code>useTranslateLanguage</code>) pesa %s gzip, misurati confrontando una build di produzione con e senza la libreria. Il payload delle traduzioni scala con i tuoi contenuti, non con la libreria._%_", SIZE.real, SIZE.real]} /></td>
          </tr>
          <tr>
